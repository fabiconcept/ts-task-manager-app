...
export default function GroupChatSection() {
    return (
        <section className="h-screen px-2 py-4 border-l sm:w-[25rem] w-screen dark:bg-black/50 bg-white/50 dark:border-white/5 border-black/5 flex flex-col">
            <div className="flex justify-between items-baseline mt-6 py-2 px-4 flex-shrink-0">
                <span className="font-semibold">
                    Members <span className="text-theme-main cursor-pointer">(<span className="underline">25</span>)</span>
                </span>
