    ...
    return (
        <div className="relative group">
            <section className={clsx(
                "h-screen p-4 flex flex-col gap-12 py-8 overflow-hidden shadow-md border-r border-transparent group-hover:dark:border-white/10 group-hover:border-black/10",
