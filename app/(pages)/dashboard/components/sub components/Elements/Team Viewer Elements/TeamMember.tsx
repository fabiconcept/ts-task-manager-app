...
export default function TeamMember({ data }: { data: UserAccountDetails }) {
    ...
    return (
        <div className="flex flex-col items-center gap-4 h-fit w-full">
            <div className='rounded-md dark:bg-white/5 bg-dark/5 w-full h-[10rem] hover:dark:bg-white/20 hover:bg-dark/10 border-2 dark:border-white/50 hover:border-theme-text border-black/50 relative overflow-hidden'>
                <div className={clsx(
