    ...
    return (
        <section className="h-[3.15rem] relative mt-8">
            <div className={clsx(
                ...
                <div className="flex gap-3 items-center py-2 px-3 active:scale-90 hover:bg-red-500/50 group">
                    ...
                    <span className="flex-1 select-none group-hover:text-white">Log out</span>
                </div>
            </div>
